...
var ContractProxy = class {
  constructor(web3Client, contractConfig) {
    ...
    __publicField(this, "contractConfig");
   ...
   */
  async callContract(functionName, args, waitForConfirmation = true) {
...
function buildContractsProxy(client, contracts) {
  const contractsProxy = {};
  if (!contracts) {
...
var Web3Client = class {
  ...
  constructor(config = {}) {
    ...
    __publicField(this, "publicClient", null);
    __publicField(this, "walletClient", null);
    __publicField(this, "chain", null);
    // 合约代理对象
    __publicField(this, "contracts");
    // 事件监听器存储
    __publicField(this, "accountsChangedListeners", /* @__PURE__ */ new Set());
    __publicField(this, "chainChangedListeners", /* @__PURE__ */ new Set());
    // 钱包事件监听器是否已启动
    __publicField(this, "walletListenersStarted", false);
    // 钱包事件监听器的包装函数（用于移除）
    __publicField(this, "walletAccountsChangedWrapper");
    __publicField(this, "walletChainChangedWrapper");
    this.config = config;
  ...
  async callContract(options, waitForConfirmation = true) {
    ...
    try {
      ...
      const formattedAddress = getAddress(contractAddress);
      const formattedArgs = formatAddressArgs(options.args) ?? options.args;
      let chain = walletClient.chain ?? this.chain ?? void 0;
      if (!chain) {
  ...
  startWalletListeners() {
    ...
    this.walletAccountsChangedWrapper = (...args) => {
    ...
    this.walletChainChangedWrapper = (...args) => {
...
function createWeb3Client(config = {}) {
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=web3-client.esm.js.map
